...
## 💊 TRIGLYCERIDE VARIABLES

### 💉 triglycerides

* **Type:** Continuous (numeric)
* **Description:** Triglyceride concentration in the blood
* **Unit:** mg/dL
* **What it measures:** Triglycerides are a type of fat circulating in the blood and are an important marker of metabolic and cardiovascular health.

| Value       | Meaning                | Status      |
| ----------- | ---------------------- | ----------- |
| < 150 mg/dL | Normal triglycerides   | 🟢 Normal   |
| ≥ 150 mg/dL | Elevated triglycerides | 🔴 Elevated |

* **Key Insight:** 🎯 Elevated triglycerides are commonly associated with insulin resistance and metabolic dysfunction.

### 📊 triglycerides_binary

* **Type:** Binary (0/1)
* **Description:** Presence of elevated triglycerides
* **Categories:**

  * 0 = 🟢 Normal triglycerides (**< 150 mg/dL**)
  * 1 = 🔴 Elevated triglycerides (**≥ 150 mg/dL**)
* **Use:** For simple prevalence comparisons and as the binary outcome for prediction models
...
| triglycerides             | Continuous  | mg/dL             | ✅ Complete |
| triglycerides_binary      | Binary      | <150 / ≥150 mg/dL | ✅ Complete |
...
### 💊 Group 4: Elevated Triglycerides

* **Outcome:** `triglycerides_binary`
...
* Diabetes is associated with increased risk of cognitive decline 📉
* Related to vascular and metabolic health 🧠
* Important for quality of life 🎯

### 😊 Mental Health (CESD)

* Depression is more common among people with diabetes 🔴
* Can affect diabetes self-management and metabolic control 📉
* Important for holistic care 💚

### 💊 Triglycerides

* Important marker of lipid and metabolic health ❤️
* Elevated triglycerides are common in insulin resistance 📊
* Associated with cardiovascular risk ⚠️
* Potentially related to lifestyle factors captured by wearables, including physical activity, sedentary behavior and sleep ⌚
